...
\usepackage[pdftex]{graphicx} % input graphics 
...
\author{
    \inputgraphics[width=14cm]{grafik/index} \\
...
\begin{document}
    ...
    \input{Analyse/EmergencyPlanning}
    \input{Analyse/PriserOgServices}
    \input{Analyse/Stakeholders}
		\input{Analyse/Supervisors}
    \input{Analyse/ProblemStatemen}
    \input{Analyse/Flyvninger}
